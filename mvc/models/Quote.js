...
const getFilteredQuote = (date, name, word, callback) => {
/*     console.log(name); */
...
const getSortedByDate = (sort, callback) => {
  console.log(sort);
  connection.query(
...
const postQuote = (date, name, word, callback) => {
...
const toggleMotivation = (id, callback) => {
  connection.query(
...
const eliminateNotMotivateMe = (callback) => {
  connection.query(
...
module.exports = {
  getAllQuotes, getIDQuote, getFilteredQuote, getSortedByDate, postQuote, toggleMotivation, eliminate, eliminateNotMotivateMe
};
